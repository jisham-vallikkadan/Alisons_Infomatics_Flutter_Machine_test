    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          hintStyle: widget.hintStyle ??
              ...
              suffix:InkWell(onTap: widget.onTapSuffix,
                child: Text(widget.sufixText??"")) ,
          ...
          focusedBorder:widget.borderside?? OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: const BorderSide(color: Color(0XFFE1E8F2))),
          errorBorder: widget.borderside?? OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: const BorderSide(color: Colors.red)),
          focusedErrorBorder:widget.borderside?? OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: const BorderSide(color: Color(0XFFE1E8F2))),
          enabledBorder:widget.borderside?? OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
